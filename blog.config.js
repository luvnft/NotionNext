...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'aaf9f93776c742ab85eefea49871b1e6',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'en-US', // e.g 'en-US','en-US'  see /lib/lang.js for more.
  ...
  COMMENT_GISCUS_LANG: process.env.NEXT_PUBLIC_COMMENT_GISCUS_LANG || 'en-US', // 你的 Giscus 語言 e.g 'en', 'zh-TW', 'en-US', 預設 'en'
